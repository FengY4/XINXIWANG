local OrionLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/FengY4/XINXIWANG/refs/heads/main/Fwngui.lua"))()
...
local Window = OrionLib:MakeWindow({Name = "殺脚本", HidePremium = false, SaveConfig = true,IntroText = "殺脚本", ConfigFolder = "殺脚本"})

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "殺脚本"; Text ="殺脚本"; Duration = 4; })
...
about:AddParagraph("作者QQ2736691058")
about:AddParagraph("qq群320578893")
about:AddParagraph("作者名")
